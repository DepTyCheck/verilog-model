...
Show VHDLReflectionProtectedType where
  show VALUE_MIRROR_PT               = "value_mirror_pt"
  show SUBTYPE_MIRROR_PT             = "subtype_mirror_pt"
  show ENUMERATION_VALUE_MIRROR_PT   = "enumeration_value_mirror_pt"
  show ENUMERATION_SUBTYPE_MIRROR_PT = "enumeration_subtype_mirror_pt"
  show INTEGER_VALUE_MIRROR_PT       = "integer_value_mirror_pt"
  show INTEGER_SUBTYPE_MIRROR_PT     = "integer_subtype_mirror_pt"
  show FLOATING_VALUE_MIRROR_PT      = "floating_value_mirror_pt"
  show FLOATING_SUBTYPE_MIRROR_PT    = "floating_subtype_mirror_pt"
  show PHYSICAL_VALUE_MIRROR_PT      = "physical_value_mirror_pt"
  show PHYSICAL_SUBTYPE_MIRROR_PT    = "physical_subtype_mirror_pt"
  show RECORD_VALUE_MIRROR_PT        = "record_value_mirror_pt"
  show RECORD_SUBTYPE_MIRROR_PT      = "record_subtype_mirror_pt"
  show ARRAY_VALUE_MIRROR_PT         = "array_value_mirror_pt"
  show ARRAY_SUBTYPE_MIRROR_PT       = "array_subtype_mirror_pt"
  show ACCESS_VALUE_MIRROR_PT        = "access_value_mirror_pt"
  show ACCESS_SUBTYPE_MIRROR_PT      = "access_subtype_mirror_pt"
  show FILE_VALUE_MIRROR_PT          = "file_value_mirror_pt"
  show FILE_SUBTYPE_MIRROR_PT        = "file_subtype_mirror_pt"
  show PROTECTED_VALUE_MIRROR_PT     = "protected_value_mirror_pt"
  show PROTECTED_SUBTYPE_MIRROR_PT   = "protected_subtype_mirror_pt"
