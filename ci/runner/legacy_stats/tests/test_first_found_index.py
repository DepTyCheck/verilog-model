...
FOUND_MISSING_FF = os.path.join(DATA_DIR, "found_errors_missing_first_found")
FOUND_UNPARSEABLE = os.path.join(DATA_DIR, "found_errors_unparseable")
FOUND_DUPLICATE = os.path.join(DATA_DIR, "found_errors_duplicate")
