...
from regression_analyze.tests.test_expected import TestBuildExpected
...
if __name__ == "__main__":
    run_test_suite([TestParseExampleFilename, TestBuildReproducibilityTable, TestBuildExpected])
