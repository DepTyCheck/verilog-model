...
- list: Which list the issue belongs to: `issues` (main) or `controversial` or `warnings`. Required.
- issue_type: The type of the issue (crash, bad_message, infinite_loop, feature, downstream, warning)
...
- issue_links: 
  ...
  - link_name: Text to show
  - link_icon: Icon to show
- maintainers_response: The reaction of tool maintainers (bug, enhancement, low, wontfix)
- stage: The stage or context in which the error was found (parsing, synthesis, simulation)
